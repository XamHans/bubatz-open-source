...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="w-full px-4 py-8 sm:px-6 md:px-8 lg:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 rounded-xl bg-[#F3F3F3] p-6 pt-12 shadow-sm md:mt-12">
          {showSuccess && (
            <Alert className="mb-8 bg-green-50 text-green-800">
              <CheckCircle className="h-4 w-4" />
              <AlertDescription>
                Vielen Dank für Ihre Nachricht! Wir werden uns in Kürze bei
                Ihnen melden.
              </AlertDescription>
            </Alert>
          )}
