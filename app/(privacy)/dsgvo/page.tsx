...
function DataCollection() {
  return (
    <section>
      ...
      <p className="mb-4">
        We collect and use only your email address for the purpose of
        authentication when you use our learning management system. This is
        necessary to provide you with access to our services and to ensure the
        security of your account.
      </p>
      <p className="mb-4">
        The legal basis for processing your email address is Article 6(1)(b) of
        the GDPR, as it is necessary for the performance of a contract to which
        you are a party or to take steps at your request prior to entering into
        a contract.
      </p>
      <p className="mb-4">
        We do not use your email address for any other purpose, such as
        marketing, unless you have explicitly consented to such use.
      </p>
      <p className="mb-4">
        Your email address will be stored for as long as you maintain an active
        account with our service. If you choose to delete your account, your
        email address will be removed from our active databases.
      </p>
    </section>
  )
}
  ...
  return (
    <section>
      ...
      <ul className="mb-4 list-disc pl-5">
        ...
        <li>
          The right to rectification if the personal data we hold about you is
